...
EXPECTED_IDENTITY_TABLES = {
    ...
    "games_filterpreset",
    "games_game",
    "games_historicalplaytime",
    "games_historicalplaytimerun",
    "games_libraryevent",
    "games_librarycalendar",
    "games_libraryeventreference",
    "games_libraryeventstreamhead",
    "games_libraryidempotencyrecord",
    "games_listcolumnchoice",
    "games_platform",
    "games_playergame",
    "games_playersession",
    "games_playthrough",
