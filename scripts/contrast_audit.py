...
CASES = [
    ...
    (
        "version footer (slate-300 on white) [intentionally faint]",
        "light",
        "slate-300",
        col("slate-300"),
        "white",
    ...
    (
        "version footer (slate-600 on gray-950) [intentionally faint]",
        "dark",
        "slate-600",
        col("slate-600"),
        "gray-950",
    ...
    # ── Status/chips ──
    (
        "toast success (green-800 on green-50)",
        "light",
        "green-800",
        col("green-800"),
        "green-50",
    ...
    (
        "toast success (green-200 on green-900)",
        "dark",
        "green-200",
        col("green-200"),
        "green-900",
    ...
    (
        "toast error (red-200 on red-900)",
        "dark",
        "red-200",
        col("red-200"),
        "red-900",
