...
OKLCH = {
    ...
    "rose-50": (0.969, 0.015, 12.422),  # from tailwind theme.css rose scale
...
CASES = [
    ...
    (
        "text-heading on page (neutral-primary)",
        "light",
        "gray-900",
        col("gray-900"),
        "white",
    ...
    (
        "text-heading on control (neutral-secondary-medium)",
        "light",
        "gray-900",
        col("gray-900"),
        "gray-50",
    ...
    (
        "text-body/placeholder on control",
        "light",
        "gray-600",
        col("gray-600"),
        "gray-50",
    ...
    (
        "text-heading on brand-soft (Pill/Badge/popover)",
        "light",
        "gray-900",
        col("gray-900"),
        "brand-soft",
    ...
    (
        "text-fg-brand on hover surface (gray-100)",
        "light",
        "blue-700",
        col("blue-700"),
        "gray-100",
    ...
    (
        "control border vs page (default-medium)",
        "light",
        "gray-200",
        col("gray-200"),
        "white",
    ...
    (
        "text-fg-brand on hover surface (gray-700)",
        "dark",
        "blue-500",
        col("blue-500"),
        "gray-700",
    ...
    (
        "table body text on zebra-odd (gray-500 on white)",
        "light",
        "gray-500",
        col("gray-500"),
        "white",
    ...
    (
        "table body text on zebra-even (gray-500 on gray-50)",
        "light",
        "gray-500",
        col("gray-500"),
        "gray-50",
    ...
    (
        "table row hover (heading gray-900 on gray-100)",
        "light",
        "gray-900",
        col("gray-900"),
        "gray-100",
    ...
    (
        "table caption (heading gray-900 on gray-100)",
        "light",
        "gray-900",
        col("gray-900"),
        "gray-100",
    ...
    (
        "table caption (heading white on gray-800)",
        "dark",
        "white",
        col("white"),
        "gray-800",
    ...
    (
        "field error (white on danger rose-700)",
        "light",
        "white",
        col("white"),
        "rose-700",
    ...
    (
        "pagination link (gray-500 on white)",
        "light",
        "gray-500",
        col("gray-500"),
        "white",
    ...
    (
        "pagination disabled (fg-disabled gray-400 on white) [disabled, exempt]",
        "light",
        "gray-400",
        col("gray-400"),
        "white",
    ...
    (
        "pagination current (white on brand blue-700)",
        "light",
        "white",
        col("white"),
        "blue-700",
    ...
    (
        "dropdown item hover (gray-600 text-body on gray-100)",
        "light",
        "gray-600",
        col("gray-600"),
        "gray-100",
    ...
    (
        "version footer (fg-disabled gray-400 on white) [intentionally faint]",
        "light",
        "gray-400",
        col("gray-400"),
        "white",
    ...
    (
        "theme-toggle icon (gray-500 on white)",
        "light",
        "gray-500",
        col("gray-500"),
        "white",
    ...
    (
        "table body text on zebra-odd (gray-400 on gray-900)",
        "dark",
        "gray-400",
        col("gray-400"),
        "gray-900",
    ...
    (
        "table body text on zebra-even (gray-400 on gray-800)",
        "dark",
        "gray-400",
        col("gray-400"),
        "gray-800",
    ...
    (
        "table row hover (heading white on gray-700)",
        "dark",
        "white",
        col("white"),
        "gray-700",
    ...
    (
        "thead text (body gray-400 on gray-800)",
        "dark",
        "gray-400",
        col("gray-400"),
        "gray-800",
    ...
    (
        "pagination link (gray-400 on gray-800)",
        "dark",
        "gray-400",
        col("gray-400"),
        "gray-800",
    ...
    (
        "pagination current (white on brand blue-600)",
        "dark",
        "white",
        col("white"),
        "blue-600",
    ...
    (
        "pagination disabled (fg-disabled gray-600 on gray-800) [disabled, exempt]",
        "dark",
        "gray-600",
        col("gray-600"),
        "gray-800",
    ...
    (
        "dropdown item (gray-400 text-body on frosted gray-800/40)",
        "dark",
        "gray-400",
        col("gray-400"),
        "frosted",
    ...
    (
        "dropdown item hover (white on gray-700)",
        "dark",
        "white",
        col("white"),
        "gray-700",
    ...
    (
        "version footer (fg-disabled gray-600 on gray-950) [intentionally faint]",
        "dark",
        "gray-600",
        col("gray-600"),
        "gray-950",
    ...
    (
        "stats zebra text (gray-600 body on indigo-100)",
        "light",
        "gray-600",
        col("gray-600"),
        "indigo-100",
    ...
    (
        "stats zebra text (gray-600 body on indigo-200)",
        "light",
        "gray-600",
        col("gray-600"),
        "indigo-200",
    ...
    (
        "stats zebra border (slate-500 vs indigo-100)",
        "light",
        "slate-500",
        col("slate-500"),
        "indigo-100",
    ...
    (
        "stats zebra text (gray-400 body on slate-800)",
        "dark",
        "gray-400",
        col("gray-400"),
        "slate-800",
    ...
    (
        "stats zebra text (gray-400 body on slate-900)",
        "dark",
        "gray-400",
        col("gray-400"),
        "slate-900",
    ...
    # ── Status/chips ──
    (
        "toast success (fg-success-strong emerald-900 on success-soft emerald-50)",
        "light",
        "emerald-900",
        col("emerald-900"),
        "emerald-50",
    ...
    (
        "toast success (fg-success-strong emerald-300 on success-soft emerald-950)",
        "dark",
        "emerald-300",
        col("emerald-300"),
        "emerald-950",
    ...
    (
        "toast error (fg-danger-strong rose-900 on danger-soft rose-50)",
        "light",
        "rose-900",
        col("rose-900"),
        "rose-50",
    ...
    (
        "toast error (fg-danger-strong rose-300 on danger-soft rose-950)",
        "dark",
        "rose-300",
        col("rose-300"),
        "rose-950",
    ...
    (
        "AND chip (teal-200 on teal-500/20)",
        "dark",
        "teal-200",
        col("teal-200"),
        "chip",
    ...
    (
        "OR chip (orange-800 on orange-100)",
        "light",
        "orange-800",
        col("orange-800"),
        "orange-100",
    ...
    (
        "OR chip (orange-200 on orange-500/20)",
        "dark",
        "orange-200",
        col("orange-200"),
        "chip",
    ...
    (
        "NOT-on chip (amber-900 on amber-100)",
        "light",
        "amber-900",
        col("amber-900"),
        "amber-100",
    ...
    (
        "builder warning (amber-700 on white)",
        "light",
        "amber-700",
        col("amber-700"),
        "white",
    ...
    (
        "builder warning (amber-400 on gray-950)",
        "dark",
        "amber-400",
        col("amber-400"),
        "gray-950",
    ...
    (
        "degraded pill text (gray-600 on secondary-medium/50)",
        "light",
        "gray-600",
        col("gray-600"),
        "pill",
    ...
    (
        "degraded pill text (gray-400 on secondary-medium/50)",
        "dark",
        "gray-400",
        col("gray-400"),
        "pill",
...
for role, theme, fgname, fg, bgname, bg, threshold in CASES:
    ...
    ok = contrast >= threshold
    mark = "✅" if ok else ("⚠️" if contrast >= 3.0 and threshold == 4.5 else "❌")
    rows.append((role, theme, f"{contrast:.2f}", f"{threshold}", mark))
    if not ok:
        fails.append((role, theme, contrast, threshold))

print("| Pairing | Theme | Ratio | Req | Verdict |")
print("|---|---|---|---|---|")
for role, theme, ratio_text, threshold_text, mark in rows:
    print(f"| {role} | {theme} | {ratio_text} | {threshold_text}:1 | {mark} |")

print(f"\n{len(fails)} failures:")
for role, theme, contrast, threshold in fails:
    print(f"  {theme}: {role} — {contrast:.2f} (needs {threshold})")
