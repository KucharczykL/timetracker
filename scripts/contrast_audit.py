...
CASES = [
    ...
    (
        "thead text (gray-700 on gray-50)",
        "light",
        "gray-700",
        col("gray-700"),
        "gray-50",
    ...
    (
        "pagination disabled (gray-300 on white)",
        "light",
        "gray-300",
        col("gray-300"),
        "white",
    ...
    (
        "pagination current (white on gray-400)",
        "light",
        "white",
        col("white"),
        "gray-400",
    ...
    (
        "table row hover (gray-400 on gray-600)",
        "dark",
        "gray-400",
        col("gray-400"),
        "gray-600",
    ...
    (
        "thead text (gray-400 on gray-700)",
        "dark",
        "gray-400",
        col("gray-400"),
        "gray-700",
    ...
    (
        "pagination disabled (gray-600 on gray-800)",
        "dark",
        "gray-600",
        col("gray-600"),
        "gray-800",
