...
CASES = [
    ...
    (
        "text-body micro-label on brand-soft (tooltip)",
        "light",
        "gray-600",
        col("gray-600"),
        "brand-soft",
    ...
    (
        "locked badge (fg-warning orange-900 on warning-soft orange-50)",
        "light",
        "orange-900",
        col("orange-900"),
        "orange-50",
    ...
    (
        "locked badge (fg-warning orange-300 on warning-soft orange-950)",
        "dark",
        "orange-300",
        col("orange-300"),
        "orange-950",
